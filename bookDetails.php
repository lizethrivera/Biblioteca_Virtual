        ...
        <div class="row">
            ...
            <div class="col-6 mt-4">
                <div class="row" style="text-align: left;">
                    ...
                    <!-- No. Paginas -->
                    <div class="col-12">
                        <p class="p_Info">No. Paginas: <span class="span_Info"><?php echo $row['no_paginas']?></span></p>
                    </div>

                    <div class="col-12 mt-4 leer">
                        <a class="btn leer_libro" target="_blank" href="backend/verPDF.php?libro=<?php echo $row['iD'] ?>">Leer Libro</a>
                    </div>
