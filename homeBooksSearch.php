...
<body>
    ...
    <div class="container libros_Gallery mt-4">
        ...
        <?php
            ...
            $consulta = "SELECT * FROM libros WHERE titulo LIKE '%$_GET[busqueda]%' OR autor LIKE '%$_GET[busqueda]%'";
            ...
            $resultado = mysqli_query($conn, $consulta);
                ...
                echo "<p>No se encontraron coincidencias con la busqueda</p>";
            }
        ?>
        </div>
    </div>
